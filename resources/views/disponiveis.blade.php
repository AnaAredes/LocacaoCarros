...
<head>
    ...
    <title>Rota Certa: Encontre a sua Viatura</title>
...
<body class="bg-light-gray">
    ...
    <main class="py-8">
        ...
        <section class="container mx-auto px-4 py-8">
            <h1 class="text-3xl md:text-4xl font-bold text-primary-blue mb-8 text-center">Viaturas Disponíveis</h1>

            @if ($bens->isEmpty())
                <div class="text-center text-gray-600 p-8 bg-white rounded-lg shadow-md">
                    <p class="text-lg">Ops! Não encontramos viaturas disponíveis para as datas e critérios selecionados.
                    </p>
                    <p class="mt-2 text-md">Tente ajustar as datas ou o número de passageiros.</p>
                </div>
            @else
        ...
        <footer class="bg-dark-gray text-light-gray py-12 mt-12">
            <div class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    <h4 class="text-xl font-bold mb-4">Rota Certa</h4>
                    <p class="text-light-gray opacity-90">Sua viagem começa aqui. Praticidade e aventura em cada
                        aluguer.</p>
                </div>
                <div>
